    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                {/* Page Title */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold mb-2">Driver Verification Management</h1>
                    <div className="flex items-center gap-4">
                        <p className="text-gray-400">Manage driver safety verifications for School Pool Pass</p>
